    ...
    firebase.auth().onAuthStateChanged(function(user) {
      if (user) {
          ...
          if(mkoolima_user.emailVerified == false){
            ...
            <p><h4><i class="fas fa-exclamation-triangle"></i>Inventarii argachuu kee dura email kee mirkaneessi!</h4></p></strong> 
            <hr>
            Ergaan kun daqiiqaa 5 booda ofumaan ni bada. <br>
            <hr> 
            Mee email inbox keessan irratti verification link ergame sana ilaalaa cuqaasaa sana booda fuula kana haaromsaa. <strong>Eeyyamni inventarii kee kuusuu ni dhorkama!
            </strong>
